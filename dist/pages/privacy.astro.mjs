...
const $$Privacy = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="relative bg-white py-8"> <div class="container mx-auto flex flex-col py-8 sm:flex-row sm:items-stretch sm:justify-between sm:px-8 md:px-12 lg:px-20"> <div class="preflight-undo"> <h1>Privacy Policy</h1> <h2>1. Introduction</h2> <p>
...
1.3 Our website incorporates privacy controls which affect how we will
          ...
          your personal data. You can access the privacy controls via
          https://triffecta.com/.
</p> <p>
...
1.5 In this policy, "we", "us" and "our" refer to Triffecta Ltd. For
          more information about us, see Section 14.
</p> <h2>2. Credit</h2> <p>
2.1 This document was created using a template from Docular (<a href="https://seqlegal.com/free-legal-documents/privacy-policy">https://seqlegal.com/free-legal-documents/privacy-policy</a>).
</p> <h2>3. The personal data that we collect</h2> <p>
3.1 In this Section 3, we have set out the general categories of
          personal data that we process and in the case of personal data that we
          did not obtain directly from you, information about the source and
...
3.2 We may process data enabling us to get in touch with you ("contact
          ...
          telephone number, postal address. The source of the contact data is
...
3.3 We may process your website user account data ("account data").
          ...
          the account data may be generated by our website.
</p> <p>
...
3.5 We may process data about your use of our website and services
...
</p> <h2>4. Purposes of processing and legal bases</h2> <p>
...
4.2 Operations - We may process your personal data for the purposes of
          operating our website, providing our services, generating invoices,
          bills, and other payment-related documentation. The legal basis for
...
4.5 Direct marketing - We may process contact data, account data,
          ...
          sending direct marketing communications by email, SMS, post, and/or
          fax, and making contact by telephone for marketing-related purposes.
...
4.10 Legal claims - We may process your personal data where necessary
...
4.11 Legal compliance and vital interests - We may also process your
...
</p> <h2>5. Providing your personal data to others</h2> <p>
5.1 We may disclose [your personal data] to [our insurers and/or
          ...
          risks, obtaining professional advice].
</p> <p>
5.3 We may disclose [specify personal data category or categories] to
          [our suppliers or subcontractors] [identified at [URL]] insofar as
          reasonably necessary for [specify purposes].
</p> <p>
5.4 Financial transactions relating to [our website and services]
          [are] OR [may be] handled by our payment services providers [identify
...
5.5 In addition to the specific disclosures of personal data set out
...
</p> <h2>6. International transfers of your personal data</h2> <p>
6.1 In this Section 6, we provide information about the circumstances
          ...
          under [UK data protection law] OR [EU data protection law] OR [UK
          and/or EU data protection law].
</p> <p>
6.2 We may transfer [your personal data] from the European Economic
          Area (EEA) to the UK and process that personal data in the UK [for the
          ...
          UK is not treated as a third country under EU data protection law or
          benefits from an adequacy decision under EU data protection law; and
          we may transfer [your personal data] from the UK to the EEA and
          process that personal data in the EEA [for the purposes set out in
          this policy] [and may permit [our suppliers and subcontractors] to do
          so] during any period with respect to which EEA states are not treated
          as third countries under UK data protection law or benefit from
          adequacy regulations under UK data protection law.
</p> <p>
6.3 The hosting facilities for our website are situated in [specify
          countries]. [The competent data protection authorities have made an
          ...
          standard data protection clauses adopted or approved by the competent
          data protection authorities, a copy of which you can obtain from
          [source]] OR [[specify appropriate safeguards and means to obtain a
          copy]].]
</p> <p>
6.4 [Specify category or categories of supplier or subcontractor] [is]
          OR [are] situated in [specify countries]. [The competent data
          protection authorities have made an adequacy determination with
          ...
          clauses adopted or approved by the competent data protection
          authorities, a copy of which can be obtained from [source]] OR
...
</p> <h2>7. Retaining and deleting personal data</h2> <p>
...
7.2 Personal data that we process for any purpose or purposes shall
          ...
          purposes.
</p> <p>7.3 We will retain your personal data as follows:</p> <ul> <li>
...
</p> <h2>8. Your rights</h2> <p>
8.1 In this Section 8, we have listed the rights that you have under
          data protection law.
</p> <p>8.2 Your principal rights under data protection law are:</p> <ul> <li>
...
</p> <h2>10. Cookies that we use</h2> <p>10.1 We use cookies for the following purposes:</p> <ul> <li>
(a) analysis - we use cookies to help us to analyse the use and
            performance of our website and services. The cookies used for this
            purpose are: _ga, _gid, and _gat.
</li> <li>
(b) cookie consent - we use cookies to store your preferences in
            relation to the use of cookies more generally. The cookies used for
            this purpose are: cookies_accepted;
</li> </ul> <h2>11. Cookies used by our service providers</h2> <p>
...
11.2 We use Google Analytics which gathers information about the use
          ...
          information by visiting <a href="https://policies.google.com/technologies/partner-sites">https://policies.google.com/technologies/partner-sites</a> and you can review Google's privacy policy at <a href="https://policies.google.com/privacy">https://policies.google.com/privacy</a>. The cookies used by Google Analytics are named _ga and
          _ga+container-id.
</p> <h2>12. Managing cookies</h2> <p>
...
(a) <a href="https://support.google.com/chrome/answer/95647">https://support.google.com/chrome/answer/95647</a> (Chrome);
</li> <li>
(b) <a href="https://support.mozilla.org/en-US/products/firefox/privacy-and-security">https://support.mozilla.org/en-US/products/firefox/privacy-and-security</a> (Firefox);
</li> <li>
(c) <a href="https://help.opera.com/en/latest/security-and-privacy/">https://help.opera.com/en/latest/security-and-privacy/</a> (Opera);
</li> <li>
(d) <a href="https://support.apple.com/en-gb/guide/safari/welcome/mac">https://support.apple.com/en-gb/guide/safari/welcome/mac</a> (Safari);
</li> <li>
(e) <a href="https://support.microsoft.com/en-gb/windows/microsoft-edge-browsing-data-and-privacy-bb8174ba-9d73-dcf2-9b4a-c582b4e640dd">https://support.microsoft.com/en-gb/windows/microsoft-edge-browsing-data-and-privacy-bb8174ba-9d73-dcf2-9b4a-c582b4e640dd</a> (Edge).
</li> </ul> <p>
...
</p> <h2>14. Our details</h2> <p>14.1 This website is owned and operated by Triffecta Ltd.</p> <p>
14.2 We are registered in England and Wales under registration number
          07751595 and our registered office is at 61 Fore Street, Heavitree,
          Exeter, England, EX1 2RJ .
</p> <p>
14.3 Our principal place of business is at 61 Fore Street, Heavitree,
          Exeter, England, EX1 2RJ.
</p> <p>14.4 You can contact us:</p> <ul> <li>
(a) by post to 61 Fore Street, Heavitree, Exeter, England, EX1 2RJ;
</li> <li>(b) by telephone on 07790 831528; or</li> <li>(c) by email using markbriggs@triffecta.com.</li> </ul> <h2>15. Representatives</h2> <p>
15.1 Our representative within the UK with respect to our obligations
          under data protection law is [identify representative] and you can
          contact our representative by [contact details].
</p> <h2>16. Data protection officer</h2> <p>
16.1 Our data protection officer's contact details are: Mark Briggs,
          markbriggs@triffecta.com
</p> </div> </div> </section> ` })}`;
}, "/Users/karllieser/Documents/GitHub/triffecta/marketing-site/src/pages/privacy.astro", void 0);

const $$file = "/Users/karllieser/Documents/GitHub/triffecta/marketing-site/src/pages/privacy.astro";
const $$url = "/marketing-site/privacy";
